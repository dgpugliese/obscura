...
const BUILD_TIME = true ? "2026-07-15T09:34:16Z" : "";
...
function HeroDone({ files, onReset, link, onDownload, mode, passphrase, onBurn, canBurn }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    borderRadius: 4,
    cursor: "pointer"
  } }, "NEW")), showQR && qrDataUrl && /* @__PURE__ */ React.createElement("div", { style: {
    marginTop: 12,
    padding: 14,
    border: `1px solid ${theme.border}`,
    background: theme.panelLo,
