...
function HeroDone({ files, onReset, link, onDownload, mode, passphrase, onBurn, canBurn }) {
  ...
  const qrDataURL = useMemo(() => {
    ...
    try {
      ...
      qr.addData(link);
      qr.make();
      // SECURITY: Replaced dangerouslySetInnerHTML with createDataURL and an <img> tag to mitigate XSS vulnerabilities.
        ...
        {showQR && qrDataURL && (
          <div style={{
            ...
            <div style={{
              ...
              <img src={qrDataURL} style={{ width: "100%", height: "100%", display: "block" }} alt="QR code" />
            </div>
