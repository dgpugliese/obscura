...
function HeroDone({ files, onReset, link, onDownload, mode, passphrase, onBurn, canBurn }) {
  ...
  const qrDataUrl = useMemo(() => {
    ...
    try {
      ...
      qr.addData(link);
      qr.make();
      // cellSize, margin. Use createDataURL to prevent XSS via dangerouslySetInnerHTML
        ...
        {showQR && qrDataUrl && (
          <div style={{
            ...
            <div style={{
              ...
              {/* Security fix: using img tag with data URL instead of dangerouslySetInnerHTML to prevent XSS */}
