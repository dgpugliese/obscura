...
function HeroDone({ files, onReset, link, onDownload, mode, passphrase, onBurn, canBurn }) {
  ...
  const qrDataUrl = useMemo(() => {
    ...
    try {
      ...
      qr.addData(link);
      qr.make();
      // SECURITY: Use createDataURL to prevent XSS via SVG tag inside dangerouslySetInnerHTML.
        ...
        {showQR && qrDataUrl && (
          <div style={{
            ...
            <div style={{
              ...
              <img src={qrDataUrl} alt="QR Code" style={{ width: "100%", height: "100%", display: "block", imageRendering: "pixelated" }} />
            </div>
