...
function HeroDone({ files, onReset, link, onDownload, mode, passphrase, onBurn, canBurn }) {
  ...
  const qrDataUrl = useMemo(() => {
    ...
    try {
      ...
      qr.addData(link);
      qr.make();
      // SECURITY: Using createDataURL instead of createSvgTag to render the QR code via an <img> tag.
      // This prevents XSS vulnerabilities associated with dangerouslySetInnerHTML.
